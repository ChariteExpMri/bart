...
elseif strcmp(arg,'help')
    ...
    w={ ''
        ...
        ''
        ' #cb __Shortcuts___'
        ' #b           [left/right arrow]   #n - rotate slice -/+ 1Â°'
        ' #b [shift] + [left/right arrow]   #n - rotate slice -/+ 5Â°'
        ' #b [ctrl]  + [left/right arrow]   #n - rotate slice -/+ 0.5Â°'
        ' #b [alt]   + [left/right arrow]   #n - rotate slice -/+ 0.1Â°'
        ''};
...
if isempty(ang)
    if strcmp(task,'helppatch')
        w={ ''
            ...
            ''
            ' ROTATION'
            ' #b [shift]+             [&#x21e6;/&#x21e7; arrow] #n - translate patch -/+  1Â°'
            ' #b [shift]+[ctrl]+      [&#x21e6;/&#x21e7; arrow] #n - translate patch -/+  5Â°'
            ' #b [shift]+[ctrl]+[alt]+[&#x21e6;/&#x21e7; arrow] #n - translate patch -/+ 20Â°'
