...
% warp other nifti-files to histospace
% 
% z=[];                                                                                                                        
% z.niftis2warp = { 'AVGT_example.nii' 'AVGThemi_example.nii' };     % % select NIFTI-file(s) to warp to histoSpace                                   
% z.finalsize   = [1];                        % % determine final image-size:  [1] from input-image, [2] from logfile          
% z.save_mat    = [1];                        % % save as mat-file: {0|1} , if [1] save mat-file                               
% z.save_tif    = [1];                        % % save as tif-file                                                             
% z.debug       = [0];                        % % debug-mode, {0|1}, if [1] create plots                                       
% f_warp2histospaceOtherImages(0,z);                                                                                           
%                              
% z=[];                                                                                                                        
% z.niftis2warp = { 'AVGT_example.nii' };     % % select NIFTI-file(s) to warp to histoSpace                                   
% z.finalsize   = [1];                        % % determine final image-size:  [1] from input-image, [2] from logfile          
% z.save_mat    = [1];                        % % save as mat-file: {0|1} , if [1] save mat-file                               
% z.save_tif    = [1];                        % % save as tif-file                                                             
% z.debug       = [0];                        % % debug-mode, {0|1}, if [1] create plots                                       
% f_warp2histospaceOtherImages(1,z);                                                                                           
%                                      


function varargout=f_warp2histospaceOtherImages(showgui,x )
...
'' '' '' ''
'save_mat'   1   'save as mat-file: {0|1} , if [1] save mat-file'  'b'
'save_tif'   1   'save as tif-file'  'b'
