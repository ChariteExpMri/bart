...
if strcmp(hl.String{hl.Value},'atlas')
    [Ireg backtrafo]=bspline_transform(O_trans,u.ano,Spacing         ,0);
elseif strcmp(hl.String{hl.Value},'atlasboundary')
    [Ireg backtrafo]=bspline_transform(O_trans,u.anoboundary,Spacing  ,0);
    
else
    %Ireg=bspline_transform(O_trans,u.movimg,Spacing,3);
    
    [Ireg backtrafo]=bspline_transform(O_trans,u.movimg,Spacing       ,0);
