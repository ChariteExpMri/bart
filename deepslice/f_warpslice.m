...
function varargout=f_warpslice(showgui,x )
...
'inf1'    'warp slice (low resolution)'  ''  ''
'' '' '' ''
...
'inf10'     '_____ other _________________________' '' ''
'debug'                         1    'debugmode {0|1}; if [1] create figures during runtime'   'b'
};
...
if showgui==1
    ...
    [m z parse q2]=paramgui(p,'uiwait',1,'close',1,'editorpos',[.03 0 1 1],'figpos',[.2 .4 .7 .35 ],...
