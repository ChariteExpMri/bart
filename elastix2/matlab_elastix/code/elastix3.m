function varargout=elastix3(movingImage,fixedImage,outputDir,paramFile,elxpath,movpntfile,fixpntfile, varargin)
...
%% ===============================================
if exist('fixpntfile') && exist(fixpntfile)==2
    if double(CMD(end))~=32;         CMD=[CMD ' '];     end
  
    ads=[' -fp "' fixpntfile '" -mp "' movpntfile '"'    ];
    CMD=[CMD ads];
