...
%      "userpath/bart_userdef/userdef.mat" which is 
% or: #r <u> fullfile(userpath,'bart_userdef','userdef.mat');
%
% 
% ==============================================
% #ko   *** [1]  LOAD A STUDY FROM HISTORY  ***  
% ==============================================
% -click #b [GREEN BOOK] #n -button (open STUDY-HISTORY) of the bart GUI to open the 
%  "barthistory"-GUI.
...
%                -in this step "fullfile(userpath,'bart_userdef', 'userdef.mat')" is deleted
%  
...
% ===============================================
% barthistory('select'); % % opens this GUI
% barthistory('update'); % % update the current project to history
% barthistory('delete'); % % delete the entiry history
% barthistory('path');   % % shows filename&path of the history
% 
% 
% 
% ==============================================
...
function barthistory(task)
warning off;
%===================================================================================================

p.upa=fullfile(userpath,'bart_userdef');
...
[pac namec extc]=fileparts(ak.configfile);
...
if istest==0
  ...
  try;  movefile(u.p.fhist,fullfile(u.p.upa,'_bart_userdef.mat'),'f') ; end
end
