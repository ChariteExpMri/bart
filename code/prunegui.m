...
for i=1:length(rotangles)
    m1 = uimenu(c,'Label',['rotate ' num2str(rotangles(i)) '째'],...
...
elseif strcmp(arg,'help')
    ...
    w={ ''
        ...
        ''
        ' #cb __Shortcuts___'
        ' #b           [left/right arrow]   #n - rotate slice -/+ 1째'
        ' #b [shift] + [left/right arrow]   #n - rotate slice -/+ 5째'
        ' #b [ctrl]  + [left/right arrow]   #n - rotate slice -/+ 0.5째'
        ' #b [alt]   + [left/right arrow]   #n - rotate slice -/+ 0.1째'
        ''};
...
if isempty(ang)
    if strcmp(task,'helppatch')
        w={ ''
            ...
            ''
            ' ROTATION'
            ' #b [shift]+             [&#x21e6;/&#x21e7; arrow] #n - translate patch -/+  1째'
            ' #b [shift]+[ctrl]+      [&#x21e6;/&#x21e7; arrow] #n - translate patch -/+  5째'
            ' #b [shift]+[ctrl]+[alt]+[&#x21e6;/&#x21e7; arrow] #n - translate patch -/+ 20째'
